...
########### Sumstats for the observed data
...
#I removed the SFS distance statistics from this plot. The order of removal of statistics is changed compared to previously so I am naming the object otherwise.
...
########### Goodness of fit
# Here I do it on the dataset where the low variance statistics are excluded.
